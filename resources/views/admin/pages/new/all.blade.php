                                        ...
                                        @foreach($news as $a)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button 
                                                    data-url="{{url('admin/new/info/'.$a->id)}}" 
                                                    class="users-edit-modal-btn btn btn-primary" data-original="">
                                                        <li class="fa fa-pencil"> تعديل </li>
                                                    </button >
                                                    <a data-url="{{url('admin/new/delete/'.$a->id)}}" class="btn btn-danger modal-delete-btn"  >
...
@endif
            ...
            @section('modals')
                @include('admin.pages.new.modals.add')
                @include('admin.pages.new.modals.edit')
            @endsection

            @section('templates')
                <script id="users-edit-modal-template" type="text/html">
                    @include('admin.pages.new.templates.edit')
                </script>
            @endsection
