            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="max-w-600">
                        ...
                        <div class="forms">
                            <form action="{{route('site.contact.send') }}"
                             data-notification="fancy" onsubmit="return false" method="post">
                                <div class="row-form">
                                ...
                                <div class="row-form but-holder">
                                    <button type="submit" data-loading="انتظر..."
                                     class="sub-b ajax-submit">إرسال</button>
                                </div>
